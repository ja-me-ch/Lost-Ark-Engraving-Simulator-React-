const classEngravings = [
    ...
    {
        class: "Machinist",
        engravings: ["Arthetinean Skill", "Evolutionary Legacy"],
    },
    {
        class: "Bard",
    ...
    {
        class: "Arcanist",
        engravings: ["Empress's Grace", "Order of the Emperor"],
    },
    {
        class: "Summoner",
        engravings: ["Communication Overflow", "Master Summoner"],
    },
    {
        class: "Shadowhunter",
